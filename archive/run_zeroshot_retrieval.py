...
ROOT = "/mnt/ssd/ronak/datasets/clip_benchmark" # root used to contain all local output from CLIP Benchmark. This is primarily used for storing datasets.
...
my_parser.add_argument(
    ...
    type=str,
    required=True,
    choices=['mscoco_captions', 'flickr8k']
)
...
if dataset == "flickr8k":
    root = os.path.join(ROOT, "flickr8k/Images/")
else:
    root = ROOT
...
for seed in range(num_seeds):
    ...
    for sample_size in sample_sizes:
        ...
        commands = [
            ...
            f"--output=output/{model}/{templates}_retrieval.json",
            f"--dataset_root={root}",
